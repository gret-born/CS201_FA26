...
penguins_data <- read_csv("week03-penguins-data.qmd")
...
ggplot(data = penguins_data_from_package, aes(x = flipper_length_mm)) +
  geom_histogram()
...
ggplot(data = penguins_data_from_package, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram()
...
ggplot(data = penguins_data_from_package, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.75) + #alpha changes transparency
  scale_fill_manual(values = c("darkorange","darkorchid","cyan4"), name = "Penguin Species") +
  theme_bw() +
  labs(title = "Palmer Penguins' Flipper Length",
       subtitle = "Three species observed on three islands in the Palmer Archipelage",
       x = "Flipper Length (mm)",
       y = "Number of Penguins")
#maual colors listed in the order of the penguins(alphabetical)
...
ggplot(data = penguins_data_from_package, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.85) + #alpha changes transparency
...
```{r, message=FALSE}
ggplot(data = penguins_data_from_package, aes(y = flipper_length_mm, fill = species)) +
  geom_boxplot()
...
ggplot(data = penguins_data_from_package, aes(x = species, y = flipper_length_mm, fill = species)) +
  geom_boxplot() +
...
ggplot(data = penguins_data_from_package, aes(x = flipper_length_mm, y = body_mass_g, color = species, shape = island)) +
  geom_point() +
  scale_shape_manual(values = c(8,23,14))
...
ggplot(data = penguin_data_from_url, aes(x = culmen_depth_mm, color = species)) +
  geom_histogram() +
